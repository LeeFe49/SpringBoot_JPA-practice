...
import com.example.practice.user.model.UserLogin;
import com.example.practice.user.model.UserLoginToken;
...
//    }
    ...
    public ResponseEntity<?> ExistsEmailExceptionHandler(
    ...
    public ResponseEntity<?> updateUserPassword(@PathVariable Long id,
        ...
        User user = userRepository.findByIdAndPassword(id,
    ...
    public ResponseEntity<?> createToken(
        ...
        if (!PasswordUtils.equalPassword(userLogin.getPassword(),
            user.getPassword())) {
        ...
        return ResponseEntity.ok()
            .body(UserLoginToken.builder().token(token).build());
    }
    ...
    public ResponseEntity<?> refreshToken(HttpServletRequest request) {
        ...
        return ResponseEntity.ok()
            .body(UserLoginToken.builder().token(newToken).build());
    }
    ...
    public ResponseEntity<?> removeToken(
        ...
        try {
            ...
            return new ResponseEntity<>("토큰 정보가 정확하지 않습니다.",
                HttpStatus.BAD_REQUEST);
        }
